...
class DontPanic2 {
    ...
    public static void main(String args[]) {
        DontPanic2 player = new DontPanic2();
     ...
     */
    private Coup appliquerLePlan(Etat etat) {
    ...
    class Coup {
        ...
        public Coup(Elevator elevator, int duree, int nbClones, int nbElevators, Etat etatFinal, String ordre) {
            super();
